...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\x06offers\x18\x01 \x03(\v2\f.heint.OfferR\x06offers2\xf0\x01\n" +
	"\rBrokerService\x12*\n" +
	...
	"\x10SendOfferToNodes\x12\f.heint.Offer\x1a\x0f.heint.ResponseB\bZ\x06/protob\x06proto3"
...
var file_proto_greeter_proto_goTypes = []any{
	...
	(*HistoryResponse)(nil),  // 5: heint.HistoryResponse
}
var file_proto_greeter_proto_depIdxs = []int32{
	...
	5, // 6: heint.BrokerService.GetHistory:output_type -> heint.HistoryResponse
	4, // 7: heint.BrokerService.RegisterProducer:output_type -> heint.RegisterResponse
	0, // 8: heint.BrokerService.SendOfferToNodes:output_type -> heint.Response
